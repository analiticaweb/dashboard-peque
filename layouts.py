...
#Por lugar de compra
df_registros = pd.read_csv('https://pequedashboard.firebaseapp.com/df_registros.csv')
# Variables temporales
...
df_activos_his = pd.read_csv('https://boterosalas.github.io/reporte-peque-data/df_activos_his.csv',sep=';')
