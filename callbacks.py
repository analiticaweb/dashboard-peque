...
# Ingreso de claves - Carga de datos
df_registros = pd.read_csv("https://www.pequenin.com/dashboard-data/df_registros.csv")
...
df_primer = pd.read_csv("https://www.pequenin.com/dashboard-data/df_primer_contacto.csv")
# Variables temporales
...
df_activas = pd.read_csv("https://www.pequenin.com/dashboard-data/df_activas.csv")
...
# Ingreso de claves - Carga de datos
## por categorías
df_claves_cat = pd.read_csv("https://www.pequenin.com/dashboard-data/df_claves_cat.csv")
# Variables temporales
df_claves_cat = temp_var(df=df_claves_cat)
## Por medio
df_claves_med = pd.read_csv("https://www.pequenin.com/dashboard-data/df_claves_med.csv")
# Variables temporales
df_claves_med = temp_var(df=df_claves_med)
# Clasificacion claves
df_clasificacion_claves = pd.read_csv("https://www.pequenin.com/dashboard-data/df_clasificacion_claves.csv")
############################ End carga datos Claves ############################

############################ Start carga datos Redenciones ############################

#Por lugar de compra
df_red_lug = pd.read_csv('https://www.pequenin.com/dashboard-data/df_red_lug.csv')
#Por tipo de producto
df_red_tipo = pd.read_csv('https://www.pequenin.com/dashboard-data/df_red_tipo.csv')
# Variables temporales
...
#Por lugar de compra
df_portal_diario = pd.read_csv('https://www.pequenin.com/dashboard-data/df_portal_diario.csv')
...
df_portal_mensual = pd.read_csv('https://www.pequenin.com/dashboard-data/df_portal_mensual.csv')
